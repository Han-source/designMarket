...
.btn_pro{
   ...
   <!-- DataTales Example -->
      <div class="card-header py-3" style="background-color: #B0C4DE;">
         <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;"><span style="color: #fff;">${boardName}글목록</span></h6>
         <c:if test="${boardId == 4}">
               <c:choose>
                     <c:when test="${child == 5}"> 
                         <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;"><span style="color: #fff;">-${childBoardName}-</span></h6>
                     </c:when>
                     <c:when test="${child == 6}"> 
                         <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;"><span style="color: #fff;">-${childBoardName}-</span></h6> 
                     </c:when>
      ...
      <a><button id="btnSelledproductList" class="btn btn-default" style="text-align: center; float: right;">거래완료글</button></a>
