   ...
   <div class="card shadow mb-4">
      ...
      <div class="card-body">
         ...
         <div class="itemm_wrapper">
              ...
              <form id="frmSelledList" action="/business/myProductUploaded" method="get">
                  <input type="hidden" name="boardId" value="${boardId}">
                  <input type="hidden" name="child" value="${child}">
                ...
                <canvas id="lookChartProduct" width="400px;" height="230px;" style="position: absolute; right: 20px; top: 250px;"></canvas>
