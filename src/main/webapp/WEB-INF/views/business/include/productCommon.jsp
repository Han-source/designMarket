...
<div class="form-group">
   <label>제목</label>  <input id="title"  name="title" value="${post.title}" maxlength='30' onkeyup="validationTitle1()" class="form-control"  readonly>
...
input.addEventListener('keyup', function(e) {
  ...
  if(isNaN(value)) {
   ...
   function validationTitle1() {
       ...
       var nameJ = /^[가-힣|ㄱ-ㅎ|ㅏ-ㅣ|a-z|0-9]{2,30}$/;
       if (nameJ.test(title)) {
